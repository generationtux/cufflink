...
Cufflink will create a json file and seed your databases for a consistent way to test your API.  
After describing your data schema in the objects directory, then adding drivers to access your databases, you then have a complete seed on objects you want to test against.

Highlights
-------

* Simple CLI
* Determines what order to seed depending on dependencies
